...
describe('Characteristic e2e test', () => {
  ...
  it('should create and save Characteristics', async () => {
    ...
    await characteristicUpdatePage.setServiceIdInput('serviceId');
    expect(await characteristicUpdatePage.getServiceIdInput()).to.match(/serviceId/);
  ...
  it('should delete last Characteristic', async () => {
    ...
    expect(await characteristicDeleteDialog.getDialogTitle().getAttribute('id')).to.match(
      /adminJhipsterApp.characteristic.delete.question/
    );
